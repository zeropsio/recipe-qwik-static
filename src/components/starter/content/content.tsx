...
export default component$(() => {
  return (
    <div class={[styles.content]}>
      <span class="bg-[#222955] text-[#d2d7fc] border border-[#38417c] px-4 py-2 text-sm rounded-md">
      ...
      <div>
        ...
        <p class="text-center text-2xl">
          Qwik SSG example running on Zerops.
          <span class="block">
      ...
      <a
        href="https://app.zerops.io/recipe/qwik-static"
        target="_blank"
        class="text-lg mt-10"
      >
        <span
          class={[
            "rounded-full flex flex-row items-center justify-center space-x-4 hover:-translate-y-1 duration-300",
            styles.deploybutton,
          ]}
        >
      ...
      <div class="pt-24">
        <p class="text-center">
          ...
          <br />
          and use following (zerops.yml) instructions to build and deploy your
          app:
        </p>
        <Steps />
      </div>
