...
services:
  - hostname: app
    ...
    buildFromGit: https://github.com/zeropsio/recipe-qwik-static`.trim();
    ...
    <div>
      <div class="grid grid-cols md:grid-cols-2 font-light gap-5 md:gap-10 pt-4">
        <div class="flex flex-col gap-5">
          <CodeBlock
            fileLink="https://github.com/zeropsio/recipe-qwik-static/blob/main/zerops-project-import.yml"
            file="zerops-project-import.yml"
            code={importyaml}
          />
          <div class="flex flex-col py-12 max-h-[300px] rounded-md gap-5 px-10 bg-[#123D6F]">
            <a
              href="https://github.com/zeropsio/recipe-qwik-static"
              target="_blank"
              class={[
